...
import { syncUserDataToCloud, startAutoSync, stopAutoSync } from "./database.js";
    ...
    if (!user) {
        panel.innerHTML = `
            <div style="text-align:center; padding:2rem; color:var(--text-muted);">
                ...
                <p style="margin-bottom:1.5rem;">Sign in to sync your data across devices and access your personal account.</p>
...
window.continueAsGuest = async function () {
    closeAuthModal();
    showToast("Browsing as Guest — your data is saved locally only.", "info");
};
...
window.manualCloudSync = async function () {
    if (!currentUser) { showToast("Sign in to sync your data.", "warning"); return; }
